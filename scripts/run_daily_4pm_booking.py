#!/usr/bin/env python3
"""
Script to run daily 4PM tennis court booking locally
"""
...
def main():
    print(f'🎾 Daily 4PM Tennis Court Booking (Local Run)')
    ...
    try:
        # Run the booking with visible browser (CI=false)
        book_court(
            user_info=user_info,
        ...
        print('\n✅ Daily 4PM booking completed successfully!')
        
    except Exception as e:
        print(f'\n❌ 4PM booking failed with error: {e}')
        import traceback
        traceback.print_exc()
        sys.exit(1)
